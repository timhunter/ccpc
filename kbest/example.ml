...
let c011 = {arity = 0; tails = []; head = 5; weight = fun l -> 0.5}
let d121 = {arity = 0; tails = []; head = 6; weight = fun l -> 0.5}
...
let c441 = {arity = 0; tails = []; head = 12; weight = fun l -> 0.}
let d441 = {arity = 0; tails = []; head = 13; weight = fun l -> 0.}
let c231 = {arity = 0; tails = []; head = 8; weight = fun l -> 0.5}
let d341 = {arity = 0; tails = []; head = 9; weight = fun l -> 0.5}
...
let best_deriv_list = [(1, ((s041, [0;0]), 2.));
		       (2, ((a041, [0;0]), 2.));
		       (3, ((a021, [0;0]), 1.));
		       (4, ((b241, [0;0]), 1.));
		       (5, ((c011, []), 0.5));
